	...
	public static void main(String[] args) throws InterruptedException {
		...
		while (itr.hasNext()) {
			...
			if (!parentwindow.equalsIgnoreCase(childwindow)) {
				...
				WebElement fname = driver.findElement(By.xpath("//table[@id='t01']/tbody/tr[2]/td[1]"));
				String text1 = fname.getText();
				

				WebElement lname = driver.findElement(By.xpath("//table[@id='t01']/tbody/tr[2]/td[2]"));
				String text2 = lname.getText();
				

				WebElement age = driver.findElement(By.xpath("//table[@id='t01']/tbody/tr[2]/td[3]"));
				...
				Action seriesofact1 = builder1.moveToElement(lastname).click().keyDown(lastname, Keys.INSERT)
				...
				Action seriesofact2 = builder2.moveToElement(InputTxt).click().keyDown(InputTxt, Keys.INSERT)
						.sendKeys(text3).build();
				...
				WebElement fname2 = driver.findElement(By.xpath("//table[@id='t02']/tbody/tr[3]/td[1]"));
				String text4 = fname2.getText();
				System.out.println(text4);
				WebElement lname2 = driver.findElement(By.xpath("//table[@id='t02']/tbody/tr[3]/td[2]"));
				String text5 = lname2.getText();
				System.out.println(text5);
				WebElement age2 = driver.findElement(By.xpath("//table[@id='t02']/tbody/tr[3]/td[3]"));
